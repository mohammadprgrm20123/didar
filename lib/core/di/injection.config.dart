...
import 'package:didar_challenge_test/core/di/injuctable_csutomer.dart' as _i12;
...
import 'package:didar_challenge_test/features/customer/domain/use_case/get_customer_details_use_case.dart'
    as _i7;
import 'package:didar_challenge_test/presentation/customer/list/controller/contact_list_tab_controller.dart'
    as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.ContactListTabController>(
        () => _i10.ContactListTabController(gh<_i4.CreateCustomerUseCase>()));
    gh.factory<_i11.CreateCustomerController>(
        () => _i11.CreateCustomerController(gh<_i4.CreateCustomerUseCase>()));
    return this;
  }
}

class _$InjectableCustomerFeature extends _i12.InjectableCustomerFeature {}
