...
mixin _$ApiStatus<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FailureEntity message) failure,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(FailureEntity message)? failure,
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({FailureEntity message});
}
...
abstract class _Failure<T> extends ApiStatus<T> {
  const factory _Failure(final FailureEntity message) = _$FailureImpl<T>;
  const _Failure._() : super._();

  FailureEntity get message;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
